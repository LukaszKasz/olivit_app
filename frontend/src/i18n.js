...
const resources = {
    en: {
        translation: {
            ...
            "sidebar.goods": "Products",
            "sidebar.goodsLoggingIn": "Connecting...",
            "sidebar.goodsLoginSuccess": "InsERT nexo login completed.",
            "sidebar.goodsLoginError": "InsERT nexo login failed.",
            "sidebar.goodsLogTitle": "Login log",
            "sidebar.goodsLogClear": "Clear",
            "sidebar.goodsLogInfo": "Info",
            "sidebar.goodsLogSuccess": "OK",
            "sidebar.goodsLogError": "Error",
            "sidebar.goodsLogStart": "Starting login to InsERT nexo...",
            "sidebar.goodsLogUser": "Operator",
            "sidebar.goodsLogDatabase": "Database",
            "sidebar.goodsFetchStart": "Fetching goods from InsERT nexo...",
            "sidebar.goodsFetchSuccess": "Fetched goods",
            "sidebar.goodsFetchError": "Failed to fetch goods.",
            "sidebar.goodsNetPrice": "Net price",
            "sidebar.settings": "Settings",
            "sidebar.logout": "Logout",

            // Goods Page
            "goods.title": "Goods",
            "goods.subtitle": "List fetched from InsERT nexo",
            "goods.count": "Items",
            "goods.operator": "Operator",
            "goods.database": "Database",
            "goods.loggedAt": "Logged in at",
            "goods.empty": "No goods loaded yet.",
            "goods.colId": "ID",
            "goods.colSymbol": "Symbol",
            "goods.colName": "Name",
            "goods.colBarcode": "Barcode",
            "goods.colNetPrice": "Net price",
            "goods.colAvailable": "Available",
            "goods.colReserved": "Reserved",
            ...
            "settings.accessTokenSecret": "Access Token Secret",
            "settings.clientId": "Client ID",
            "settings.clientSecret": "Client Secret",
            "settings.consumerKey": "Consumer Key",
            "settings.consumerSecret": "Consumer Secret",
            "settings.verifySsl": "Verify SSL certificate",
    ...
    pl: {
        translation: {
            ...
            "sidebar.goods": "Towary",
            "sidebar.goodsLoggingIn": "Logowanie...",
            "sidebar.goodsLoginSuccess": "Logowanie do InsERT nexo zakończone.",
            "sidebar.goodsLoginError": "Logowanie do InsERT nexo nie powiodło się.",
            "sidebar.goodsLogTitle": "Log logowania",
            "sidebar.goodsLogClear": "Wyczyść",
            "sidebar.goodsLogInfo": "Info",
            "sidebar.goodsLogSuccess": "OK",
            "sidebar.goodsLogError": "Błąd",
            "sidebar.goodsLogStart": "Rozpoczynam logowanie do InsERT nexo...",
            "sidebar.goodsLogUser": "Operator",
            "sidebar.goodsLogDatabase": "Baza",
            "sidebar.goodsFetchStart": "Pobieram towary z InsERT nexo...",
            "sidebar.goodsFetchSuccess": "Pobrano towarów",
            "sidebar.goodsFetchError": "Nie udało się pobrać towarów.",
            "sidebar.goodsNetPrice": "Cena netto",
            "sidebar.settings": "Ustawienia",
            "sidebar.logout": "Wyloguj",

            // Goods Page
            "goods.title": "Towary",
            "goods.subtitle": "Lista pobrana z InsERT nexo",
            "goods.count": "Pozycji",
            "goods.operator": "Operator",
            "goods.database": "Baza",
            "goods.loggedAt": "Zalogowano",
            "goods.empty": "Nie pobrano jeszcze towarów.",
            "goods.colId": "ID",
            "goods.colSymbol": "Symbol",
            "goods.colName": "Nazwa",
            "goods.colBarcode": "Kod kreskowy",
            "goods.colNetPrice": "Cena netto",
            "goods.colAvailable": "Dostępny",
            "goods.colReserved": "Zarezerwowany",
            ...
            "settings.consumerKey": "Consumer Key",
            "settings.consumerSecret": "Consumer Secret",
            "settings.verifySsl": "Weryfikuj certyfikat SSL",
            "settings.save": "Zapisz ustawienia",
            "settings.saving": "Zapisywanie...",
            "settings.saved": "Ustawienia zapisane.",
            "settings.reload": "Odśwież",
            "settings.errorLoad": "Nie udało się pobrać ustawień.",
            "settings.errorSave": "Nie udało się zapisać ustawień.",
